...
class StudentHome extends Component{
    ...
    onSubmit(e) {
        ...
        if(username === "" || password === ""){
            ...
            axios.get('http://localhost:4000/student/get-student/' + username + '/' + password)
                .then(res => {
                    if(res.data[0].username === username) {
                        alert("Login Successful");
                        sessionStorage.setItem('loggedStudent',JSON.stringify(res.data[0]._id));
        ...
        return (
            <div className={'col-10 mx-auto col-md-4'}>
                <div className={'card card-body'}>
                    <h3 className={'text-center mb-5'}>Student Login</h3>
